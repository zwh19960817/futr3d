...
class FUTR3DHead(DETRHead):
    ...
    def __init__(self,
        ...
        super(FUTR3DHead, self).__init__(
    ...
    def forward(self, mlvl_pts_feats, mlvl_img_feats, radar_feats, img_metas):
        ...
        mlvl_rad_masks, mlvl_rad_positional_encodings = self.get_mask_pos_enc(radar_feats)
        ...
        return outputs_classes, outputs_coords, aux_outs
    ...
    def _get_bboxes_single(self, cls_scores, bbox_preds):
        ...
        if self.test_cfg['post_center_range'] is not None:
            ...
            mask = (final_box_preds[..., :3] >=
                    self.test_cfg['post_center_range'][:3]).all(1)
            mask &= (final_box_preds[..., :3] <=
                     self.test_cfg['post_center_range'][3:]).all(1)
